            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card shadow-sm border-0">
                        ...
                        <div class="card-body">
                            <form action="{{ url('organization/structure/edit/' . $getRecord->id) }}" method="POST">
                                @csrf
                                <div class="mb-3">
                                    <label class="form-label">Nama Posisi</label>
                                    <input type="text" name="position" class="form-control" value="{{ $getRecord->position }}" required>
                                </div>
