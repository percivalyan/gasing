            ...
            <div class="col-sm-12">
                <div class="card shadow-sm border-0">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h5 class="mb-0">Edit Event Batch</h5>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('event_batch.update', $getRecord->id) }}" method="POST" novalidate>
                            @csrf
                            @method('PUT')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="event_year" class="form-control"
                                       value="{{ old('event_year', $getRecord->event_year) }}" required>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="event_phase" class="form-control"
                                       value="{{ old('event_phase', $getRecord->event_phase) }}" required>
