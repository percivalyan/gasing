...
@section('content')
    ...
    <style>
        ...
        .welcome-overlay {
            position: absolute;
            inset: 0;
            background: radial-gradient(600px 200px at 10% 10%, rgba(255, 255, 255, .08), transparent),
                    ...
                    @php
                        $cards = [
                            ...
                            [
                                'title' => 'Ref Numbers',
                                'key' => 'ref_numbers',
                                'route' => route('referencenumber.list'),
                            ],
                            ...
                            [
                                ...
                                'key' => 'org_structs',
                                'route' => route('organization.structure.list'),
                            ],
                            [
                                'title' => 'Org. Members',
                                'key' => 'org_members',
                                'route' => route('organization.member.list'),
                            ],
                            [
                                'title' => 'Teacher Events',
                                'key' => 'teacher_events',
                                'route' => route('teacher_event.list'),
                            ],
                            [
                                'title' => 'Student Events',
                                'key' => 'student_events',
                                'route' => route('student_event.list'),
                            ],
                            [
                                'title' => 'Student Courses',
                                'key' => 'student_courses',
                                'route' => route('student_course.list'),
                            ],
                            [
                                'title' => 'Lesson Schedules',
                                'key' => 'lesson_scheds',
                                'route' => route('lesson_schedule.list'),
                            ],
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-end">
                                                        <a class="btn btn-sm btn-outline-primary"
                                                            href="{{ route('teacher_event.edit', $e->id ?? '') }}">Kelola</a>
                                                    </td>
                                                </tr>
                                            @empty
                                                <tr>
                                                    <td colspan="3" class="text-center text-muted">Tidak ada event</td>
                                                </tr>
                                            @endforelse
                                        </tbody>
                                    </table>
                                        ...
                                        <tbody>
                                            @forelse($upcomingStudentEvents as $e)
                                                <tr>
                                                    ...
                                                    <td class="text-end">
                                                        <a class="btn btn-sm btn-outline-primary"
                                                            href="{{ route('student_event.edit', $e->id ?? '') }}">Kelola</a>
                                                    </td>
                                                </tr>
                                            @empty
                                                <tr>
                    ...
                    <div class="col-12">
                        <div class="card shadow-sm">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                ...
                                @if ($can['Lesson'] ?? false)
                                    <a href="{{ route('lesson_schedule.add') }}" class="btn btn-sm btn-primary">Tambah
                                        Jadwal</a>
                                @endif
                            </div>
                            <div class="card-body p-0">
                                        ...
                                        <tbody>
                                            @forelse($todaySchedules as $s)
                                                <tr>
                                                    ...
                                                    <td>{{ $s->location ?? '-' }}</td>
                                                    <td class="text-end">
                                                        <a href="{{ route('lesson_schedule.edit', $s->id ?? '') }}"
                                                            class="btn btn-sm btn-outline-primary">Edit</a>
                                                    </td>
                                                </tr>
                                            @empty
                                                <tr>
                                                    <td colspan="5" class="text-center text-muted">Tidak ada jadwal untuk
                                                        hari ini</td>
                                                </tr>
                                            @endforelse
                                        </tbody>
                    ...
                    <div class="col-12">
                        <div class="welcome-wrap shadow-sm">
                            ...
                            <div class="welcome-content">
                                ...
                                <h2 class="welcome-title mb-2 text-white">Selamat Datang,
                                    {{ auth()->user()->name ?? 'Pengguna' }} 👋</h2>
                                <p class="mb-0 text-white-50">
                                    Anda masuk sebagai <strong
                                        class="text-white">{{ optional(auth()->user()->role)->name ?? 'User' }}</strong>.
