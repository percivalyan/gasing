      ...
      <div class="col-sm-12">
        <div class="card shadow-sm border-0">
          <div class="card-header">
            <h5 class="mb-0">Daftar Guru (Guru Les Gasing)</h5>
          </div>
          <div class="card-body">
            <div class="mb-3">
            ...
            <div class="small text-muted">Halaman ini opsional; untuk AJAX gunakan endpoint <code>picker.teachers.search</code>.</div>
          </div>
        </div>
      </div>
    </div>
