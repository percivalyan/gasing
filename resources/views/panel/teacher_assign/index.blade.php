    ...
    <div class="row">
      <div class="col-sm-12">
        ...
        <div class="card shadow-sm border-0">
          ...
          <div class="card-body">
            {{-- Filter --}}
            <form class="row g-2 mb-3" method="GET" action="{{ route('assign.index') }}">
              <div class="col-md-4">
              ...
              <div class="col-md-4">
                <select name="student_course_id" class="form-control">
                  ...
                  @foreach ($students as $s)
                    <option value="{{ $s->id }}" {{ request('student_course_id') == $s->id ? 'selected' : '' }}>
              ...
              <table class="table table-hover align-middle">
                ...
                @forelse ($records as $row)
                  <tr>
                    ...
                    <td class="text-end">
                      <a href="{{ route('assign.edit', $row->id) }}" class="btn btn-sm btn-warning me-1">Edit</a>

                      <form action="{{ route('assign.toggle', $row->id) }}" method="POST" class="d-inline">
                        @csrf
                      ...
                      <form action="{{ route('assign.delete', $row->id) }}" method="POST" class="d-inline"
                ...
                @empty
                  <tr><td colspan="8" class="text-center">Belum ada penugasan.</td></tr>
                @endforelse
                </tbody>
              </table>
            </div>
