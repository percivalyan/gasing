        ...
        <div class="card shadow-sm border-0">
          <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex gap-2">
              ...
              <input type="text" id="s" class="form-control form-control-sm" placeholder="Cari nama...">
            </div>
          </div>
          <div class="card-body">
            ...
            <div class="small text-muted">Halaman ini opsional; untuk AJAX gunakan endpoint <code>picker.students.search</code>.</div>
          </div>
        </div>
      </div>
    </div>
